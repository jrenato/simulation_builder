...
class_name EntityTracker extends RefCounted
...
## the same location.
func place_entity(entity, cellv: Vector3) -> void:
...
func remove_entity(cellv: Vector3) -> void:
	...
	Events.entity_removed.emit(entity, cellv)
	entity.queue_free()
